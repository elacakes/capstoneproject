...
?>
<div class="container w-100 mt-3" id="formContainer" style="margin-bottom:5rem;">
    <!-- sign up modal -->
        ...
        <div class="col-lg-8 col-md-10 col-sm-12">
            <div class="p-4 shadow position-relative">
                ...
                <form action="action.php" method="POST">
                    <h3 class="text-center fw-bold mb-2 mt-0">Create New Account</h3>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-floating">
                                <input type="password" name="password" class="form-control" id="password" placeholder="Password" required oninput="validatePasswordLength()" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="stay" class="form-control" id="stay" placeholder="Year of Residency" required>
                                <label for="stay" class="text-mute-0">Residency<small>(e,g,.2000)</small></label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                ...
                                <small>(<i>Write deceased if dead</i>)</small>
                                <label for="father_name">Father's Name <sup>*</sup></label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <button type="submit" name="submit_user" class="btn btn-primary w-100 fw-bold" onclick="return validatePassword()">Sign Up</button>
                    </div>
                </form>
            </div>
        </div>
